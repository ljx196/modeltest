...
from .dataset import WordVocab, vocab
...
def train_():
    vocab_path = 'C:\WorkSpace\expressions-synthetic\equaldataout.small'
    train_dataset = 'C:\WorkSpace\expressions-synthetic\equaldatatrain.txt'
    test_dataset = 'C:\WorkSpace\expressions-synthetic\equaldatatest.txt'
    seq_len = 64
    on_memory = True
    batch_size = 64
    num_workers = 4
    ...
    log_freq = 10
    epochs = 10
    output_path = 'C:\WorkSpace\expressions-synthetic\model'
